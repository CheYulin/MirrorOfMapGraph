...
/******************************************************************************
 * Kernel configuration policy for fused-iteration direction optimal BFS kernels.
 ******************************************************************************/
...
/**
 * Kernel configuration policy for fused-iteration direction BFS kernels.
 *
...
struct KernelPolicy : _ProblemType
{
	...
	typedef bottom_up_contract_atomic::KernelPolicy<
		_ProblemType,
		CUDA_ARCH,
		_INSTRUMENT,
		SATURATION_QUIT,
		...
		CONTRACT_WORK_STEALING,
		CONTRACT_LOG_SCHEDULE_GRANULARITY>
		BottomUpContractKernelPolicy;



	typedef bottom_up_expand_atomic::KernelPolicy<
		_ProblemType,
		CUDA_ARCH,
		_INSTRUMENT,
		SATURATION_QUIT,
	...
	union SmemStorage
	{
        ...
        typename BottomUpContractKernelPolicy::SmemStorage 	bottomupcontract;
		typename BottomUpExpandKernelPolicy::SmemStorage 	bottomupexpand;
