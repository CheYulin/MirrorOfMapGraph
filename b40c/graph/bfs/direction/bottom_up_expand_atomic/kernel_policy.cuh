...
/******************************************************************************
 * Kernel configuration policy for bottom-up BFS frontier expansion kernels.
 ******************************************************************************/
...
/**
 * Kernel configuration policy for bottom-up BFS frontier contraction kernels.
 *
