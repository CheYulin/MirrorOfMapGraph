...
namespace b40c
{
  namespace graph
  {
    ...
    struct CooEdgeTuple
    {
      ...
      CooEdgeTuple(VertexId row, VertexId col, Value val) :
    ...
    bool DimacsTupleCompare(CooEdgeTuple elem1, CooEdgeTuple elem2)
    {
    ...
    template<typename CooEdgeTuple>
    bool UniqueTupleCompare(CooEdgeTuple elem1, CooEdgeTuple elem2)
    {
      return (elem1.row == elem2.row && elem1.col == elem2.col);
    }
     ...
     *   */
    template<typename CooEdgeTuple>
    bool DimacsTupleCompare2(CooEdgeTuple elem1, CooEdgeTuple elem2)
    {
