...
/******************************************************************************
 * BC atomic backward summation kernel
 ******************************************************************************/
...
#include <b40c/graph/GASengine/vertex_centric/backward_sum_atomic/cta.cuh>
...
/**
 * Backward summation pass (non-workstealing)
 */
...
struct SweepPass
{
	...
	static __device__ __forceinline__ void Invoke(
        ...
        typename KernelPolicy::EValue           *&d_node_values,
        typename KernelPolicy::VertexId         *&d_labels,
        typename KernelPolicy::EValue           *&d_sigmas,
        typename KernelPolicy::EValue           *&d_deltas,
        typename KernelPolicy::SizeT            *&d_visit_flags,
...
struct Dispatch<KernelPolicy, true>
{
		...
		util::KernelRuntimeStats	&kernel_stats)
	{
		...
		SweepPass<KernelPolicy, KernelPolicy::WORK_STEALING>::Invoke<KernelPolicy::SmemStorage>(
		    iteration,
			queue_index,
			steal_index,
			num_gpus,
...
/******************************************************************************
 * Backward summation Kernel Entrypoint
 ******************************************************************************/

/**
 * Backward summation kernel entry point
 */
template <typename KernelPolicy>
...
void Kernel(
    ...
    typename KernelPolicy::EValue           *d_node_values,             // Node values
    typename KernelPolicy::VertexId         *d_labels,
    typename KernelPolicy::EValue           *d_sigmas,
    typename KernelPolicy::EValue           *d_deltas,
    typename KernelPolicy::SizeT            *d_visit_flags,
