        ...
        namespace gather
        {
          ...
          struct SweepPass
          {
            ...
            static __device__ __forceinline__ void Invoke(typename KernelPolicy::VertexId &queue_index, typename KernelPolicy::VertexId &steal_index, int &num_gpus,
                typename KernelPolicy::VertexId *&d_vertex_frontier, typename KernelPolicy::VertexId *&d_edge_frontier, typename KernelPolicy::VertexId *&d_predecessor,
                typename KernelPolicy::VertexId *&d_column_indices, typename KernelPolicy::SizeT *&d_row_offsets, typename KernelPolicy::EValue *&d_dists, int *&d_changed,
                typename KernelPolicy::SizeT *&d_visit_flags, util::CtaWorkProgress &work_progress, util::CtaWorkDistribution<typename KernelPolicy::SizeT> &work_decomposition,
                typename KernelPolicy::SizeT &max_edge_frontier, SmemStorage &smem_storage)
            {
              ...
              Cta cta(queue_index, num_gpus, smem_storage, d_vertex_frontier, d_edge_frontier, d_predecessor, d_column_indices, d_row_offsets, d_dists, d_changed, d_visit_flags, work_progress,
                  max_edge_frontier);
          ...
          struct Dispatch
          {
            ...
            static __device__ __forceinline__ void Kernel(VertexId &queue_index, VertexId &steal_index, int &num_gpus, volatile int *&d_done, VertexId *&d_vertex_frontier, VertexId *&d_edge_frontier,
                VertexId *&d_predecessor, VertexId *&d_column_indices, SizeT *&d_row_offsets, int* &d_dists, int *&d_changed, SizeT *&d_visit_flags, util::CtaWorkProgress &work_progress,
          ...
          struct Dispatch<KernelPolicy, true>
          {
                ...
                SizeT &max_vertex_frontier, SizeT &max_edge_frontier, util::KernelRuntimeStats &kernel_stats)
            {
              ...
              SweepPass<KernelPolicy, KernelPolicy::WORK_STEALING>::Invoke(queue_index, steal_index, num_gpus, d_vertex_frontier, d_edge_frontier, d_predecessor, d_column_indices, d_row_offsets,
                  d_dists, d_changed, d_visit_flags, work_progress, smem_storage.state.work_decomposition, max_edge_frontier, smem_storage);
//
              if (KernelPolicy::INSTRUMENT && (threadIdx.x == 0))
              {
          ...
          void Kernel(typename KernelPolicy::VertexId queue_index,				// Current frontier queue counter index
              ...
              int* d_dists, int *d_changed, typename KernelPolicy::SizeT *d_visit_flags, util::CtaWorkProgress work_progress,			// Atomic workstealing and queueing counters
          ...
          {
            Dispatch<KernelPolicy>::Kernel(queue_index, steal_index, num_gpus, d_done, d_vertex_frontier, d_edge_frontier, d_predecessor, d_column_indices, d_row_offsets, d_dists, d_changed,
                d_visit_flags, work_progress, max_vertex_frontier, max_edge_frontier, kernel_stats);
          }
