...
int main(int argc, char **argv)
{
  ...
  if (csr_problem.FromHostProblem(g_stream_from_host, csr_graph.nodes, csr_graph.edges, 1, src, csr_graph.column_indices, csr_graph.row_offsets, csr_graph.edge_values, csr_graph.row_indices,
...
//  std::vector<int> strategies(1, VERTEX_CENTRIC);
  ...
  retval = vertex_centric.EnactIterativeSearch<CsrProblem, sssp>(csr_problem, src[0], source_file_name, csr_graph.row_offsets, max_grid_size, max_queue_sizing);
